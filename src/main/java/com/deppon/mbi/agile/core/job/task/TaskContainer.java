...
public class TaskContainer {
	 ...
	 */
	private String name = Constants.DEFAULT_CONTAINER_NAME;
	 ...
	 * 最大任务组数据量, 默认10
	 */
	private int maxGroup = Constants.MAX_GROUP;
	...
	public TaskContainer() {
		taskGroupMap.put(Constants.DEFAULT_GROUP, new TaskGroup(Constants.DEFAULT_GROUP));
	}
	...
	public TaskGroup addGroup(String groupName) {
		return addGroup(groupName, Constants.DEFAULT_MAX_TASK);
	}
	...
	public void addTask(Task task) throws TaskException {
		this.addTask(task, Constants.DEFAULT_GROUP);
	}
	...
	public void removeTask(String taskName) throws TaskException {
		this.removeTask(taskName, Constants.DEFAULT_GROUP);
	}
	...
	public void removeGroup(String groupName) throws TaskException {
		if (!groupName.equals(Constants.DEFAULT_GROUP)) {
	...
	public void startTask(String taskName) throws TaskException {
		startTask(taskName, Constants.DEFAULT_GROUP);
	}
	...
	public void pauseTask(String taskName) throws TaskException {
		pauseTask(taskName, Constants.DEFAULT_GROUP);
	}
	...
	public void stopTask(String taskName) throws TaskException {
		stopTask(taskName, Constants.DEFAULT_GROUP);
	}
	...
	public void setName(String name) {
		if (StringUtils.isNotEmpty(name)) {
			...
			this.name = Constants.DEFAULT_CONTAINER_NAME+"-" + Long.toString(System.currentTimeMillis());
		}
	}
	...
	public TaskContainerDaemon getDaemon() {
		return daemon;
	}

	public void setDaemon(TaskContainerDaemon daemon) {
		this.daemon = daemon;
	}
